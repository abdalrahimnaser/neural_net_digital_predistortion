...
architecture behave of nn_act_BUS_A_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_PARAMS_DATA_0 : INTEGER := 16#10#;
    constant ADDR_PARAMS_CTRL   : INTEGER := 16#14#;
    ...
    -- internal registers
    signal int_params          : UNSIGNED(31 downto 0) := (others => '0');
