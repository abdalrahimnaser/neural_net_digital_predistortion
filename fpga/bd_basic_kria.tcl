...
proc create_hier_cell_channel_00 { parentCell nameHier } {
  ...
  connect_bd_net -net aclk1_1 [get_bd_pins aclk1] [get_bd_pins axi_bram_in_im/s_axi_aclk] [get_bd_pins axi_bram_in_re/s_axi_aclk] [get_bd_pins axi_bram_out_im/s_axi_aclk] [get_bd_pins axi_bram_out_re/s_axi_aclk] [get_bd_pins nn_act/ap_clk]
  connect_bd_net -net aresetn1_1 [get_bd_pins aresetn1] [get_bd_pins axi_bram_in_im/s_axi_aresetn] [get_bd_pins axi_bram_in_re/s_axi_aresetn] [get_bd_pins axi_bram_out_im/s_axi_aresetn] [get_bd_pins axi_bram_out_re/s_axi_aresetn] [get_bd_pins nn_act/ap_rst_n]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins channel_00/aresetn1] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins channel_00/aclk1] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M04_ACLK]
...
\
  ...
  assign_bd_address -offset 0xB1000000 -range 0x00020000 -with_name SEG_axi_bram_ctrl_im0_Mem0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_in_im/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB2000000 -range 0x00020000 -with_name SEG_axi_bram_ctrl_re0_Mem0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_in_re/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB3000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_out_im/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB4000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_out_re/S_AXI/Mem0] -force
