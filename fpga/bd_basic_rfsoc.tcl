...
################################################################
# This is a generated script based on design: io_kria
#
...
proc create_hier_cell_channel_00 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_BRAM_In_Re

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_BRAM_In_Im

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_Lite

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_BRAM_Out_Im

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_BRAM_Out_Re
  ...
  # Create instance: axi_bram_in_im, and set properties
  set axi_bram_in_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_in_im ]
  ...
  # Create instance: axi_bram_in_re, and set properties
  set axi_bram_in_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_in_re ]
  set_property -dict [list \
    CONFIG.DATA_WIDTH {128} \
    CONFIG.SINGLE_PORT_BRAM {1} \
  ] $axi_bram_in_re
  ...
  # Create instance: blk_mem_gen_im0, and set properties
  set blk_mem_gen_im0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_im0 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $blk_mem_gen_im0


  # Create instance: blk_mem_gen_re0, and set properties
  set blk_mem_gen_re0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_re0 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $blk_mem_gen_re0


  # Create instance: xlconstant_0, and set properties
  set xlconstant_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_0 ]

  # Create instance: nn_act, and set properties
  set nn_act [ create_bd_cell -type ip -vlnv xilinx.com:hls:nn_act:1.0 nn_act ]

  # Create instance: axi_bram_out_im, and set properties
  set axi_bram_out_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_out_im ]
  set_property -dict [list \
    CONFIG.DATA_WIDTH {128} \
    CONFIG.SINGLE_PORT_BRAM {1} \
  ] $axi_bram_out_im
  ...
  # Create instance: axi_bram_out_re, and set properties
  set axi_bram_out_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_out_re ]
  set_property -dict [list \
    CONFIG.DATA_WIDTH {128} \
    CONFIG.SINGLE_PORT_BRAM {1} \
  ] $axi_bram_out_re
  ...
  # Create instance: blk_mem_gen_im1, and set properties
  set blk_mem_gen_im1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_im1 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $blk_mem_gen_im1


  # Create instance: blk_mem_gen_re1, and set properties
  set blk_mem_gen_re1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_re1 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $blk_mem_gen_re1


  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axi_bram_in_re/S_AXI] [get_bd_intf_pins S_AXI_BRAM_In_Re]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins axi_bram_in_im/S_AXI] [get_bd_intf_pins S_AXI_BRAM_In_Im]
  connect_bd_intf_net -intf_net S_AXI_BRAM_Out_Im_1 [get_bd_intf_pins S_AXI_BRAM_Out_Im] [get_bd_intf_pins axi_bram_out_im/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_BRAM_Out_Re_1 [get_bd_intf_pins S_AXI_BRAM_Out_Re] [get_bd_intf_pins axi_bram_out_re/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_Lite_1 [get_bd_intf_pins S_AXI_Lite] [get_bd_intf_pins nn_act/s_axi_BUS_A]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_in_re/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_re0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA1 [get_bd_intf_pins axi_bram_in_im/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_im0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA2 [get_bd_intf_pins axi_bram_out_re/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_re1/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA3 [get_bd_intf_pins axi_bram_out_im/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_im1/BRAM_PORTA]
  connect_bd_intf_net -intf_net nn_act_sigImIn_PORTA [get_bd_intf_pins nn_act/sigImIn_PORTA] [get_bd_intf_pins blk_mem_gen_im0/BRAM_PORTB]
  connect_bd_intf_net -intf_net nn_act_sigImOut_PORTA [get_bd_intf_pins nn_act/sigImOut_PORTA] [get_bd_intf_pins blk_mem_gen_im1/BRAM_PORTB]
  connect_bd_intf_net -intf_net nn_act_sigReIn_PORTA [get_bd_intf_pins nn_act/sigReIn_PORTA] [get_bd_intf_pins blk_mem_gen_re0/BRAM_PORTB]
  connect_bd_intf_net -intf_net nn_act_sigReOut_PORTA [get_bd_intf_pins nn_act/sigReOut_PORTA] [get_bd_intf_pins blk_mem_gen_re1/BRAM_PORTB]

  # Create port connections
  connect_bd_net -net aclk1_1 [get_bd_pins aclk1] [get_bd_pins axi_bram_in_re/s_axi_aclk] [get_bd_pins axi_bram_in_im/s_axi_aclk] [get_bd_pins axi_bram_out_im/s_axi_aclk] [get_bd_pins axi_bram_out_re/s_axi_aclk] [get_bd_pins nn_act/ap_clk]
  connect_bd_net -net aresetn1_1 [get_bd_pins aresetn1] [get_bd_pins axi_bram_in_re/s_axi_aresetn] [get_bd_pins axi_bram_in_im/s_axi_aresetn] [get_bd_pins axi_bram_out_im/s_axi_aresetn] [get_bd_pins axi_bram_out_re/s_axi_aresetn] [get_bd_pins nn_act/ap_rst_n]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins nn_act/ap_start]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M00_AXI [get_bd_intf_pins axi_interconnect/M00_AXI] [get_bd_intf_pins channel_00/S_AXI_BRAM_In_Re]
  connect_bd_intf_net -intf_net axi_interconnect_M01_AXI [get_bd_intf_pins axi_interconnect/M01_AXI] [get_bd_intf_pins channel_00/S_AXI_BRAM_In_Im]
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins channel_00/S_AXI_Lite]
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins axi_interconnect/M03_AXI] [get_bd_intf_pins channel_00/S_AXI_BRAM_Out_Im]
  connect_bd_intf_net -intf_net axi_interconnect_M04_AXI [get_bd_intf_pins axi_interconnect/M04_AXI] [get_bd_intf_pins channel_00/S_AXI_BRAM_Out_Re]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins channel_00/aresetn1] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins channel_00/aclk1] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M04_ACLK]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  set_property CONFIG.NUM_MI {1} $axi_interconnect_ps
  ...
  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins transmitter/s_axi_aresetn] [get_bd_pins axi_interconnect_ps/ARESETN] [get_bd_pins axi_interconnect_ps/S00_ARESETN] [get_bd_pins axi_interconnect_ps/M00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins transmitter/s_axi_aclk] [get_bd_pins axi_interconnect_ps/ACLK] [get_bd_pins axi_interconnect_ps/S00_ACLK] [get_bd_pins axi_interconnect_ps/M00_ACLK]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {1} $axi_hpm1_fpd
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_hpm1_fpd_M00_AXI [get_bd_intf_pins axi_hpm1_fpd/M00_AXI] [get_bd_intf_pins radio/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_hpm1_fpd/ARESETN]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins radio/s_axi_aresetn] [get_bd_pins axi_hpm1_fpd/S00_ARESETN] [get_bd_pins axi_hpm1_fpd/M00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins radio/s_axi_aclk] [get_bd_pins axi_hpm1_fpd/ACLK] [get_bd_pins axi_hpm1_fpd/S00_ACLK] [get_bd_pins axi_hpm1_fpd/M00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  ...
  assign_bd_address -offset 0xB1000000 -range 0x00080000 -with_name SEG_axi_bram_ctrl_im0_Mem0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_in_im/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB2000000 -range 0x00080000 -with_name SEG_axi_bram_ctrl_re0_Mem0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_in_re/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB3000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_out_im/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB4000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_bram_out_re/S_AXI/Mem0] -force
  assign_bd_address -offset 0xB0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/nn_act/s_axi_BUS_A/Reg] -force
